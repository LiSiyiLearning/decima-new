...
parser.add_argument('--exec_level_range', type=int, default=16,
                    help='the level range of exectutors (default: 16)')
parser.add_argument('--exec_level_num', type=int, default=[50, 30,40,20],
                    nargs='+',help='the number of different kinds of executors (default: 50 executors each kind)')
parser.add_argument('--time_interval', type=int, default=900,
                    help='the time interval between executor change wave (default: 25)')
parser.add_argument('--job_num', type=int, default=478, help='the amount of job_dag used in training (default: 478)')
...
parser.add_argument('--exec_cpus', type=float,
                    default=[2.0, 2.0,2.0,2.0,6.0,6.0,6.0,6.0,8.0,8.0,8.0,8.0,16.0,16.0,16.0,16.0], nargs='+',
                    help='Amount of CPU in each type group (default: [1.0, 1.0])')
parser.add_argument('--exec_mems', type=float,
                    default=[3.0, 8.0,10.0,30.0,3.0, 8.0,10.0,30.0,3.0, 8.0,10.0,30.0,3.0, 8.0,10.0,30.0], nargs='+',
...
# -- Learning --
parser.add_argument('--node_input_dim', type=int, default=37,
                    help='node input dimensions to graph embedding (default: 5)')
parser.add_argument('--job_input_dim', type=int, default=32,
...
parser.add_argument('--reset_prob', type=float, default=0.4,
                    help='Probability for episode to reset (after x seconds) (default: 0)')
parser.add_argument('--reset_prob_decay', type=float, default=0.02,
